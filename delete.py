...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1.configure(text='''Delete''')
        ...
        self.Button2.place(relx=0.739, rely=0.854, height=44, width=157)
        self.Button2.configure(activebackground="#ececec")
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#4338d8")
        self.Button2.configure(disabledforeground="#a3a3a3")
        self.Button2.configure(font="-family {Comic Sans MS} -size 11 -weight bold -slant italic")
        self.Button2.configure(foreground="#aab23e")
        self.Button2.configure(highlightbackground="#d9d9d9")
        self.Button2.configure(highlightcolor="black")
        self.Button2.configure(pady="0")
        self.Button2.configure(text='''Open address file''')
            ...
            for i in range(0, len(line)):
                if line[add % 60] == '-1':
                    ...
                    if arr[0] == usn:
                        ...
                        if tm.askokcancel("Delete", "Are you sure you want to Delete?"):
                            tm.showinfo("Search Info", "Record Deleted")

                        
                        af.close()
                        f = open(self.Entry2.get(), 'w')
                        for i in line:
                            if not i:
                                exit()
                            f.write(i)
